...
class HttpHeaderDeletePage(ttk.Frame):
    def __init__(self, parent):
        ...
        # Title Label
        title_label = ttk.Label(self, text="Delete HTTP Header Manager", font=("Arial", 16, "bold"))
        ...
        # Add Header button
        add_button = ttk.Button(self, text="+ Add Header to Delete", bootstyle="success", command=self.add_header_row)
        ...
        # Configure grid row weight to make the header section flexible
